...
<!-- Design POS Restaurant Order with outline -->
            ...
            <div id="left-side" class="w-full lg:w-[65%] p-5 space-y-8">
                ...
                <section>
                    ...
                    <ul id="food-items" class="cardContainer grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
                        ...
                        <!-- food 1 -->
                        <li class="p-5 bg-white space-y-5 shadow-md rounded-2xl outline outline-1 outline-[color:rgba(var(--ni-danger-400))] relative hover:scale-105 duration-150" data-value="food 1">
                        ...
                        <!-- food 2 -->
                        <li class="p-5 bg-white space-y-5 shadow-md rounded-2xl outline outline-1 outline-[color:rgba(var(--ni-danger-400))] relative hover:scale-105 duration-150" data-value="food 2">
                        ...
                        <!-- food 3 -->
                        <li class="p-5 bg-white space-y-5 shadow-md rounded-2xl outline outline-1 outline-[color:rgba(var(--ni-danger-400))] relative hover:scale-105 duration-150" data-value="food 3">
                        ...
                        <!-- food 4 -->
                        <li class="p-5 bg-white space-y-5 shadow-md rounded-2xl outline outline-1 outline-[color:rgba(var(--ni-danger-400))] relative hover:scale-105 duration-150" data-value="food 4">
                        ...
                        <!-- food 5 -->
                        <li class="p-5 bg-white space-y-5 shadow-md rounded-2xl outline outline-1 outline-[color:rgba(var(--ni-danger-400))] relative hover:scale-105 duration-150" data-value="food 5">
                        ...
                        <!-- food 6 -->
                        <li class="p-5 bg-white space-y-5 shadow-md rounded-2xl outline outline-1 outline-[color:rgba(var(--ni-danger-400))] relative hover:scale-105 duration-150" data-value="food 6">
...
<script>
    ...
    // POS Restaurant Order with outline function
    const posRestaurantOrderWithOutline = () => {
