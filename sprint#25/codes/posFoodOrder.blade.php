        ...
        <div class="flex flex-col lg:flex-row select-none">
            ...
            <div id="left-side" class="w-full lg:w-[65%] p-5 space-y-8">
                ...
                <nav class="cardContainer grid grid-cols-2 md:grid-cols-3 2xl:grid-cols-5">
                    ...
                    <!-- signature -->
                    <div class="cursor-pointer flex justify-center items-center py-2 bg-white hover:bg-[color:rgba(var(--ni-danger-500))] hover:text-white shadow-md rounded-md duration-300">
                ...
                <section>
                    ...
                    <!-- foods container -->
                    <div id="food-items" class="cardContainer grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">

                        <!-- food 1 -->
                        <div class="cursor-pointer p-4 bg-white space-y-4 shadow-lg rounded-xl relative hover:scale-105 duration-150" data-value="food 1">
                        ...
                        <!-- food 2 -->
                        <div class="cursor-pointer p-4 bg-white space-y-4 shadow-lg rounded-xl relative hover:scale-105 duration-150" data-value="food 2">
                        ...
                        <!-- food 3 -->
                        <div class="cursor-pointer p-4 bg-white space-y-4 shadow-lg rounded-xl relative hover:scale-105 duration-150" data-value="food 3">
                        ...
                        <!-- food 4 -->
                        <div class="cursor-pointer p-4 bg-white space-y-4 shadow-lg rounded-xl relative hover:scale-105 duration-150" data-value="food 4">
                        ...
                        <!-- food 5 -->
                        <div class="cursor-pointer p-4 bg-white space-y-4 shadow-lg rounded-xl relative hover:scale-105 duration-150" data-value="food 5">
                        ...
                        <!-- food 6 -->
                        <div class="cursor-pointer p-4 bg-white space-y-4 shadow-lg rounded-xl relative hover:scale-105 duration-150" data-value="food 6">
