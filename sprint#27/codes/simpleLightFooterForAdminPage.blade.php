...
<!-- Design Simple light Footer for Admin page -->

<!-- main -->
<div class="mainCard">
    <div class="h-screen flex justify-center items-center bg-[color:rgba(var(--ni-gray-100))] p-5 rounded-lg">

        <!-- footer -->
        <footer class="divide-y divide-[color:rgba(var(--ni-gray-200))] w-full bg-white shadow-lg rounded-xl">
            ...
            <div class="p-5">
                <div class="flex flex-col 2xl:flex-row justify-center sm:justify-items-stretch items-center sm:items-stretch">
                    ...
                    <!-- search bar -->
                    <div class="relative w-48 sm:w-full 2xl:w-96 mr-0 2xl:mr-3 border border-[color:rgba(var(--ni-primary-400))] text-[color:rgba(var(--ni-gray-400))] rounded-md">
                        ...
                        <input id="search" class="select-none w-48 sm:w-96 h-11 border-0 bg-transparent pl-11 pr-4 outline-none text-[color:rgba(var(--ni-primary-500))] placeholder-[color:rgba(var(--ni-gray-500))] dark:placeholder-[color:rgba(var(--ni-gray-300))] focus:ring-0 text-sm" type="search" placeholder="Enter an product, service, tool..." data-search>
                    </div>
                    ...
                    <div class="select-none flex flex-col lg:flex-row justify-center items-center">
                        ...
                        <div id="dropdown" class="flex flex-col sm:flex-row justify-start sm:justify-center 2xl:justify-start items-start sm:items-center 2xl:items-start space-x-0 sm:space-x-3 space-y-3 sm:space-y-0 mr-0 lg:mr-3 mt-3 2xl:mt-0 text-[color:rgba(var(--ni-gray-500))]">
                            ...
                            <div class="dropdown inline-block relative my-auto">
                                <button class="inline-flex justify-center items-center w-48 sm:w-32 h-12 border border-[color:rgba(var(--ni-primary-400))] hover:bg-[color:rgba(var(--ni-primary-400))] hover:text-white rounded-md duration-200">
                                    <span class="text-sm mr-1">All Systems</span>
                                    <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z"/> </svg>
                                </button>
                                <ul id="systems-dropdown" class="dropdown-menu z-30 absolute w-48 sm:w-52 md:w-80 divide-y divide-[color:rgba(var(--ni-gray-200))] border border-[color:rgba(var(--ni-gray-200))] bg-white text-sm text-[color:rgba(var(--ni-gray-500))]" data-dropdown></ul>
                            </div>
                            ...
                            <div class="dropdown inline-block relative my-auto">
                                ...
                                <ul id="products-dropdown" class="dropdown-menu z-30 absolute w-48 sm:w-52 md:w-80 divide-y divide-[color:rgba(var(--ni-gray-200))] border border-[color:rgba(var(--ni-gray-200))] bg-white text-sm text-[color:rgba(var(--ni-gray-500))]" data-dropdown></ul>
                            </div>
                            ...
                            <div class="dropdown inline-block relative my-auto">
                                ...
                                <ul id="services-dropdown" class="dropdown-menu z-30 absolute w-48 sm:w-52 md:w-80 divide-y divide-[color:rgba(var(--ni-gray-200))] border border-[color:rgba(var(--ni-gray-200))] bg-white text-sm text-[color:rgba(var(--ni-gray-500))]" data-dropdown></ul>
                            </div>
                        </div>
            ...
            <div class="p-5">
                <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0">
                    <div class="flex justify-center sm:justify-start items-center sm:items-start space-x-5 my-auto">
                        ...
                        <!-- dashboard -->
                        <div class="cursor-pointer flex text-xs sm:text-sm text-[color:rgba(var(--ni-gray-500))] hover:text-[color:rgba(var(--ni-primary-500))]">
                    ...
                    <div class="flex justify-center items-center ml-0 sm:ml-auto">
                        <button class="flex justify-center items-center my-auto w-48 sm:w-32 lg:w-28 xl:w-32 py-2 border border-[color:rgba(var(--ni-primary-400))] hover:bg-[color:rgba(var(--ni-primary-400))] text-[color:rgba(var(--ni-primary-500))] hover:text-white rounded-lg duration-300">
                            <div class="p-1 bg-white rounded-full">
