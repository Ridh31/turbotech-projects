...
<!-- Design Simple light Command Palettes (Search) -->
...
<script>
    ...
    // Design Simple light Command Palettes (Search) function
    const simpleLightCommandPalettes = () => {
