...
<!--------------------------------------------------------------------------
➤ data center equipment placement request
<-------------------------------------------------------------------------->
<div class="mainCard">
        ...
        <div class="eachCard col-span-1 p-0">
            ...
            <div class="px-5 border-b py-3">
                <h1 class="font-medium text-[rgba(var(--ni-primary-500))] leading-7 line-clamp-1">
                    <span class="font-content font-bold">ទម្រង់ស្នើសុំដាក់ឧបករណ៍របស់មជ្ឈមណ្ឌល​ទិន្នន័យ</span> / 
                    <span>DATA CENTER EQUIPMENT PLACEMENT REQUEST</span>
                </h1>
            </div>
            ...
            <div class="p-5 grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-2">
                ...
                <div class="col-span-2 flex justify-end gap-x-2">
                    ...
                    <button type="button" onclick="saveModel(this,'dataCenterEquipmentPlacementRequest','/eApprovals/form/dataCenterEquipmentPlacementRequest','/eApprovals/form')" class="button -primary text-sm py-1 waves-effect"> Save </button>
                </div>
            </div>
        </div>
    </form>
