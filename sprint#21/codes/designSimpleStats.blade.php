...
<div class="mainCard">
    <!-- main card -->
    <ul class="cardContainer grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2s lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 bg-gray-100">

        <!-- Total Subscribers -->
        <li class="px-0 pt-0 col-span-2 md:col-span-1">
            <div class="shadow-md rounded-md m-5 bg-white border">
                <div class="px-5 pt-5">
                    <p class="text-sm text-muted">Total Subscribers</p>
                    <h1 class="text-3xl">71,897</h1>
                </div>     
