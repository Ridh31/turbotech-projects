...
<!-- Design Sample Pricing with Rounded, outline, and Shadow card page -->
...
<div class="mainCard">
    ...
    <div class="cardContainer px-5 sm:px-5 md:px-10 lg:px-10 py-5 bg-[color:rgba(var(--ni-gray-50))]">
        ...
        <div class="col-span-1 w-full text-center">
            <div class="container p-5 mx-auto items-center">
                <div class="w-full mx-auto">
                    <h1 class="font-bold text-4xl text-[color:rgba(var(--ni-gray-600))]">Sample Pricing with Rounded, outline, and Shadow card page</h1>
        ...
        <ul class="cardContainer grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 select-none mt-0">
            ...
            <li class="eachCard col-span-1 w-auto outline outline-2 outline-[color:rgba(var(--ni-gray-400))] rounded-xl shadow-lg transform transition duration-500 hover:scale-105">
