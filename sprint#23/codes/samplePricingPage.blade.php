...
<div class="mainCard">
    ...
    <div class="cardContainer px-5 sm:px-5 md:px-10 lg:px-10 py-5 bg-[color:rgba(var(--ni-gray-100))]">
        ...
        <div class="col-span-1 w-full text-center">
            <div class="container p-5 mx-auto items-center">
                <div class="w-full mx-auto">
                    <h1 class="font-bold text-4xl text-[color:rgba(var(--ni-gray-600))]">Sample Pricing page</h1>
        ...
        <!-- pricing cards -->
        <ul class="cardContainer grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 select-none">

            <!-- "personal plan" pricing card -->
            <li class="eachCard col-span-1 w-auto rounded-xl shadow-lg border-t-8 border-[color:rgba(var(--ni-gray-600))] transform transition duration-500 hover:scale-105">
                <div class="w-full mx-auto p-3">

                    <!-- personal badge -->
                    <div class="flex w-full">
                        <h1 class="font-bold text-md bg-[color:rgba(var(--ni-gray-100))] text-[color:rgba(var(--ni-gray-600))] px-3 py-1 rounded-2xl">Personal Plan</h1>
                    </div>
                    ...
                    <div class="mt-5">
                        ...
                        <p class="font-bold text-[color:rgba(var(--ni-gray-500))] text-sm pt-2">For individuals that need to record & share quick videos.</p>
                    </div>
                    ...
                    <!-- button -->
                    <div class="mt-5">
                        <button class="w-full mt-5 p-2 rounded-lg border border-[color:rgba(var(--ni-primary-500))] hover:border-[color:rgba(var(--ni-primary-500))] hover:bg-[color:rgba(var(--ni-primary-500))] text-[color:rgba(var(--ni-primary-600))] hover:text-white duration-500">Get Start Now</button>
                    </div>
                </div>
            </li>

            <!-- "basic plan" pricing card -->
            <li class="eachCard col-span-1 w-auto rounded-xl shadow-lg border-t-8 border-[color:rgba(var(--ni-yellow-400))] transform transition duration-500 hover:scale-105">
                <div class="w-full mx-auto p-3">

                    <!-- basic badge -->
                    <div class="flex w-full">
                        <h1 class="font-bold text-md bg-[color:rgba(var(--ni-gray-100))] text-[color:rgba(var(--ni-gray-600))] px-3 py-1 rounded-2xl">Basic Plan</h1>
                        <svg class="w-5 h-5 ml-2 my-auto text-[color:rgba(var(--ni-yellow-400))] animate-bounce fill-[color:rgba(var(--ni-yellow-400))]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="mt-5">
                        ...
                        <p class="font-bold text-[color:rgba(var(--ni-gray-500))] text-sm pt-2">For individuals that need advanced recording & editing.</p>
                    </div>
                    ...
                    <!-- button -->
                    <div class="mt-5">
                        <button class="w-full mt-5 p-2 rounded-lg border border-[color:rgba(var(--ni-primary-500))] bg-[color:rgba(var(--ni-primary-500))] hover:border-[color:rgba(var(--ni-primary-600))] hover:bg-[color:rgba(var(--ni-primary-600))] text-white duration-500">Start Free Trial</button>
                    </div>
                </div>
            </li>

            <!-- "pro plan" pricing card -->
            <li class="eachCard col-span-1 w-auto rounded-xl shadow-lg border-t-8 border-[color:rgba(var(--ni-danger-400))] transform transition duration-500 hover:scale-105">
                <div class="w-full mx-auto p-3">

                    <!-- pro badge -->
                    <div class="flex w-full">
                        <h1 class="font-bold text-md bg-[color:rgba(var(--ni-gray-100))] text-[color:rgba(var(--ni-gray-600))] px-3 py-1 rounded-2xl">Pro Plan</h1>
                    </div>
                    ...
                    <div class="mt-5">
                        ...
                        <p class="font-bold text-[color:rgba(var(--ni-gray-500))] text-sm pt-2">For teams that need advanced sharing & reporting.</p>
                    </div>
                    ...
                    <!-- button -->
                    <div class="mt-5">
                        <button class="w-full mt-5 p-2 rounded-lg border border-[color:rgba(var(--ni-primary-500))] hover:border-[color:rgba(var(--ni-primary-500))] hover:bg-[color:rgba(var(--ni-primary-500))] text-[color:rgba(var(--ni-primary-600))] hover:text-white duration-500">Request Access</button>
                    </div>
                </div>
            </li>

            <!-- "enterprise plan" pricing card -->
            <li class="eachCard col-span-1 w-auto rounded-xl shadow-lg border-t-8 border-[color:rgba(var(--ni-primary-400))] transform transition duration-500 hover:scale-105">
                <div class="w-full mx-auto p-3">

                    <!-- enterprise badge -->
                    <div class="flex w-full">
                        <h1 class="font-bold text-md bg-[color:rgba(var(--ni-gray-100))] text-[color:rgba(var(--ni-gray-600))] px-3 py-1 rounded-2xl">Enterprise Plan</h1>
                    </div>
                    ...
                    <div class="mt-5">
                        ...
                        <p class="font-bold text-[color:rgba(var(--ni-gray-500))] text-sm pt-2">For teams that need advanced admin & security. (Unlimited plus)</p>
                    </div>
